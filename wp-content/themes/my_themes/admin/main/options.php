...
function thinkup_customizer_theme_options( $wp_customize ) {
    ...
    // Add Image Slide 4 - Info
    $wp_customize->add_setting(
        'thinkup_redux_variables[thinkup_homepage_sliderimage4_info]',
        array(
            'type'                 => 'option',
            'capability'           => 'edit_theme_options',
            'theme_supports'       => '',
    ...
    $wp_customize->add_control(
        new thinkup_customizer_customcontrol_raw(
            $wp_customize,
            'thinkup_homepage_sliderimage4_info',
            array(
                'label'           => __( 'Slide 4', 'experon' ),
                'section'         => 'thinkup_customizer_section_homepage',
                'settings'        => 'thinkup_redux_variables[thinkup_homepage_sliderimage4_info]',
                'active_callback' => 'thinkup_customizer_callback_active_global',
            )
        )
    );

    // Add Image Slide 4 - Image
    $wp_customize->add_setting(
        'thinkup_redux_variables[thinkup_homepage_sliderimage4_image][url]',
        array(
            'type'                 => 'option',
            'capability'           => 'edit_theme_options',
            'theme_supports'       => '',
    ...
    $wp_customize->add_control(
        new WP_Customize_Image_Control(
            $wp_customize,
            'thinkup_homepage_sliderimage4_image',
            array(
                'section'         => 'thinkup_customizer_section_homepage',
                'settings'        => 'thinkup_redux_variables[thinkup_homepage_sliderimage4_image][url]',
                'label'	          => __( '', 'experon' ),
                'description'	  => __( 'Image', 'experon' ),
                'active_callback' => 'thinkup_customizer_callback_active_global',
            )
    ...
    // Add Image Slide 4 - Title
    $wp_customize->add_setting(
        'thinkup_redux_variables[thinkup_homepage_sliderimage4_title]',
        array(
            'type'                 => 'option',
            'capability'           => 'edit_theme_options',
            'theme_supports'       => '',
    ...
    $wp_customize->add_control(
        'thinkup_homepage_sliderimage4_title',
        array(
            'section'		  => 'thinkup_customizer_section_homepage',
            'settings'		  => 'thinkup_redux_variables[thinkup_homepage_sliderimage4_title]',
            'type'			  => 'text',
            'label'			  => __( '', 'experon' ),
            'description'	  => __( 'Title', 'experon' ),
            'active_callback' => 'thinkup_customizer_callback_active_global',
    ...
    // Add Image Slide 4 - Description
    $wp_customize->add_setting(
        'thinkup_redux_variables[thinkup_homepage_sliderimage4_desc]',
        array(
            'type'                 => 'option',
            'capability'           => 'edit_theme_options',
            'theme_supports'       => '',
    ...
    $wp_customize->add_control(
        'thinkup_homepage_sliderimage4_desc',
        array(
            'section'		  => 'thinkup_customizer_section_homepage',
            'settings'		  => 'thinkup_redux_variables[thinkup_homepage_sliderimage4_desc]',
            'type'			  => 'text',
            'label'			  => __( '', 'experon' ),
            'description'	  => __( 'Description', 'experon' ),
            'active_callback' => 'thinkup_customizer_callback_active_global',
    ...
    // Add Slide 4 - Page Link
    $wp_customize->add_setting(
        'thinkup_redux_variables[thinkup_homepage_sliderimage4_link]',
        array(
            'type'                 => 'option',
            'capability'           => 'edit_theme_options',
            'theme_supports'       => '',
    ...
    $wp_customize->add_control(
        'thinkup_homepage_sliderimage4_link',
        array(
            'section'		  => 'thinkup_customizer_section_homepage',
            'settings'		  => 'thinkup_redux_variables[thinkup_homepage_sliderimage4_link]',
            'type'			  => 'dropdown-pages',
            'label'			  => __( '', 'experon' ),
            'description'	  => __( 'URL', 'experon' ),
            'active_callback' => 'thinkup_customizer_callback_active_global',
    ...
    // Add Image Slide 5 - Info
    $wp_customize->add_setting(
        'thinkup_redux_variables[thinkup_homepage_sliderimage5_info]',
        array(
            'type'                 => 'option',
            'capability'           => 'edit_theme_options',
            'theme_supports'       => '',
    ...
    $wp_customize->add_control(
        new thinkup_customizer_customcontrol_raw(
            $wp_customize,
            'thinkup_homepage_sliderimage5_info',
            array(
                'label'           => __( 'Slide 5', 'experon' ),
                'section'         => 'thinkup_customizer_section_homepage',
                'settings'        => 'thinkup_redux_variables[thinkup_homepage_sliderimage5_info]',
                'active_callback' => 'thinkup_customizer_callback_active_global',
            )
        )
    );

    // Add Image Slide 5 - Image
    $wp_customize->add_setting(
        'thinkup_redux_variables[thinkup_homepage_sliderimage5_image][url]',
        array(
            'type'                 => 'option',
            'capability'           => 'edit_theme_options',
            'theme_supports'       => '',
    ...
    $wp_customize->add_control(
        new WP_Customize_Image_Control(
            $wp_customize,
            'thinkup_homepage_sliderimage5_image',
            array(
                'section'         => 'thinkup_customizer_section_homepage',
                'settings'        => 'thinkup_redux_variables[thinkup_homepage_sliderimage5_image][url]',
                'label'	          => __( '', 'experon' ),
                'description'	  => __( 'Image', 'experon' ),
                'active_callback' => 'thinkup_customizer_callback_active_global',
            )
    ...
    // Add Image Slide 5 - Title
    $wp_customize->add_setting(
        'thinkup_redux_variables[thinkup_homepage_sliderimage5_title]',
        array(
            'type'                 => 'option',
            'capability'           => 'edit_theme_options',
            'theme_supports'       => '',
    ...
    $wp_customize->add_control(
        'thinkup_homepage_sliderimage5_title',
        array(
            'section'		  => 'thinkup_customizer_section_homepage',
            'settings'		  => 'thinkup_redux_variables[thinkup_homepage_sliderimage5_title]',
            'type'			  => 'text',
            'label'			  => __( '', 'experon' ),
            'description'	  => __( 'Title', 'experon' ),
            'active_callback' => 'thinkup_customizer_callback_active_global',
    ...
    // Add Image Slide 5 - Description
    $wp_customize->add_setting(
        'thinkup_redux_variables[thinkup_homepage_sliderimage5_desc]',
        array(
            'type'                 => 'option',
            'capability'           => 'edit_theme_options',
            'theme_supports'       => '',
    ...
    $wp_customize->add_control(
        'thinkup_homepage_sliderimage5_desc',
        array(
            'section'		  => 'thinkup_customizer_section_homepage',
            'settings'		  => 'thinkup_redux_variables[thinkup_homepage_sliderimage5_desc]',
            'type'			  => 'text',
            'label'			  => __( '', 'experon' ),
            'description'	  => __( 'Description', 'experon' ),
            'active_callback' => 'thinkup_customizer_callback_active_global',
    ...
    // Add Slide 5 - Page Link
    $wp_customize->add_setting(
        'thinkup_redux_variables[thinkup_homepage_sliderimage5_link]',
        array(
            'type'                 => 'option',
            'capability'           => 'edit_theme_options',
            'theme_supports'       => '',
    ...
    $wp_customize->add_control(
        'thinkup_homepage_sliderimage5_link',
        array(
            'section'		  => 'thinkup_customizer_section_homepage',
            'settings'		  => 'thinkup_redux_variables[thinkup_homepage_sliderimage5_link]',
            'type'			  => 'dropdown-pages',
            'label'			  => __( '', 'experon' ),
            'description'	  => __( 'URL', 'experon' ),
            'active_callback' => 'thinkup_customizer_callback_active_global',
