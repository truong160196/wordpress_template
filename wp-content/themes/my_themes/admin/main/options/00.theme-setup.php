...
function thinkup_migrate_slider_page2image() {
    ...
    $thinkup_homepage_sliderpage4 = thinkup_var ( 'thinkup_homepage_sliderpage4' );
    $thinkup_homepage_sliderpage5 = thinkup_var ( 'thinkup_homepage_sliderpage5' );
    ...
    $slide4_image_url = wp_get_attachment_url( get_post_thumbnail_id( $thinkup_homepage_sliderpage4 ) );
    $slide5_image_url = wp_get_attachment_url( get_post_thumbnail_id( $thinkup_homepage_sliderpage5 ) );
    ...
    $slide4_title = get_the_title( $thinkup_homepage_sliderpage4 );
    $slide5_title = get_the_title( $thinkup_homepage_sliderpage5 );
    ...
    $slide4_desc = apply_filters( 'the_excerpt', get_post_field( 'post_excerpt', $thinkup_homepage_sliderpage4 ) );
    $slide5_desc = apply_filters( 'the_excerpt', get_post_field( 'post_excerpt', $thinkup_homepage_sliderpage5 ) );
	...
	$thinkup_homepage_sliderpage = array(
        ...
        array(
            'slide_image_url'   => $slide4_image_url,
            'slide_title'       => $slide4_title,
            'slide_desc'        => $slide4_desc,
            'slide_link'        => $thinkup_homepage_sliderpage4
        ),
        array(
            'slide_image_url'   => $slide5_image_url,
            'slide_title'       => $slide5_title,
            'slide_desc'        => $slide5_desc,
            'slide_link'        => $thinkup_homepage_sliderpage5
        ),
	);
