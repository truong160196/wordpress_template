...
function thinkup_customizer_callback_active_global( $control ) {
	...
	if ( $thinkup_homepage_sliderswitch == 'option4' and
            ...
            $control_id == 'thinkup_homepage_sliderimage4_info' or
            $control_id == 'thinkup_homepage_sliderimage4_image' or
            $control_id == 'thinkup_homepage_sliderimage4_title' or
            $control_id == 'thinkup_homepage_sliderimage4_desc' or
            $control_id == 'thinkup_homepage_sliderimage4_link' or
            $control_id == 'thinkup_homepage_sliderimage5_info' or
            $control_id == 'thinkup_homepage_sliderimage5_image' or
            $control_id == 'thinkup_homepage_sliderimage5_title' or
            $control_id == 'thinkup_homepage_sliderimage5_desc' or
            $control_id == 'thinkup_homepage_sliderimage5_link') ) {
		return true;
	}
